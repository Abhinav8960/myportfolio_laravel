        ...
        <div class="relative -z-16 flex flex-col-reverse gap-7">
            <div class="flex items-end justify-center">
                <div class="grid w-100 2xl:w-125">
                    {{-- Macbook --}}
                    <img
                        src="{{ asset('resources/images/home/macbook.webp') }}"
                        alt=""
                        aria-hidden="true"
                    ...
                    >
                        ...
                        >
                            <img
                                src="{{asset('resources/images/home/laravel_welcome_light.webp') }}"
                                alt=""
                                aria-hidden="true"
                                class="w-55 self-center justify-self-center [grid-area:1/-1] dark:opacity-0"
                            />
                            <img
                                src="{{ asset('resources/images/home/laravel_welcome_dark.webp') }}"
                                alt=""
                                aria-hidden="true"
                ...
                {{-- Iphone --}}
                <img
                    src="{{ asset('resources/images/home/iphone.webp') }}"
                    alt=""
                    aria-hidden="true"
            ...
            >
                ...
                >
                    ...
                    <div>
                        ...
                        >
                            <img
                                src="{{ asset('resources/images/home/video_introduction_thumbnail.webp') }}"
